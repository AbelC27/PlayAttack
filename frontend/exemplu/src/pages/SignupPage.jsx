  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.formWrapper}>
        ...
        <p style={styles.subtitle}>Create your account and start your adventure</p>
        ...
        <form style={styles.form} onSubmit={handleSubmit}>
          ...
          >
            {loading ? (
              ...
              <>Sign Up <span style={styles.arrow}>→</span></>
            )}
          </button>
          ...
          <div style={styles.links}>
            <Link to="/login" style={styles.link}>
              Already have an account? <span style={styles.linkHighlight}>Sign In</span>
            </Link>
          </div>
